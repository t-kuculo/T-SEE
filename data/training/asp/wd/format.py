...
with open("../../re/wde_eq_train.json", 'r') as json_file1, open("../../re/wde_eq_test.json", 'r') as json_file2, open("../../re/wde_eq_dev.json", 'r') as json_file3:
